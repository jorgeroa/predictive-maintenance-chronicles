...
# from ke.layers.core import Dense
# from ke.layers.recurrent import LSTM, GRU, SimpleRNN
# from ke.layers import Input
# from ke.utils.data_utils import get_file
# from ke.optimizers import Nadam
# from ke.callbacks import EarlyStopping, ModelCheckpoint, ReduceLROnPlateau
...
def train(DB_seq):
    ...
    fichier=open('./LSTM/input_data/x.txt', "w+")
    fichier1=open('./LSTM/input_data/y_a.txt', "w+")
    fichier2=open('./LSTM/input_data/y_t.txt', "w+")
    ...
    model_checkpoint = ModelCheckpoint('./LSTM/output_files/model.h5', 
                                        monitor='val_loss', 
                                        verbose=0, 
                                        save_best_only=True, 
    ...
    # JGT:
    tensorboard_callback = keras.callbacks.TensorBoard(log_dir='./LSTM/output_files/summary',histogram_freq=1)
