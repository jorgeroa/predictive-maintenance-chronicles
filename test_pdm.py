...
generator=pdmdb_generator(nbitems=50,l=8, lp=8, dc=1, minstart=0.1, minduration=1, maxduration=500)

# Stores all the chronicle sequences generated by the generator 
chro_sequences = generator.generate(nb=300, l=25, npat=30, th=0.5)
...
disturbed_chro_sequences = generator.generate(nb=300, l=25, npat=30, th=0.5, patterns=disturbed_chronicles)
